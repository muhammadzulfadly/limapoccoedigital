...
export default function FormPenduduk() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      router.push("/masyarakat/pengajuan-surat/sk-rekomendasi-pembelian-bbm");
    }
  };
  ...
  return (
    <div className="flex h-full">
      <div className="flex-1 bg-gray-100 p-8">
        <h1 className="text-xl font-semibold mb-6">Pengajuan Surat / SK Rekomendasi Pembelian BBM / Buat Surat Baru</h1>
