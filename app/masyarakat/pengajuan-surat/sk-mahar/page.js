...
export default async function Page() {
  const data = [
    { tanggal: "24/03/25", jenis: "Keterangan Mahar", status: "Selesai", action: "Unduh" },
    { tanggal: "24/03/25", jenis: "Keterangan Mahar", status: "Butuh Konfirmasi", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan Mahar", status: "Ditolak", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan Mahar", status: "Ditolak", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan Mahar", status: "Sedang proses", action: "Buka" },
  ];
    ...
    <div className="flex h-full">
      <div className="flex-1 bg-gray-100 p-8">
        <h1 className="text-xl font-semibold mb-6">
          Pengajuan Surat / <span className="font-bold">SK Mahar</span>
        </h1>
        <div className="bg-white rounded-md shadow-sm p-8 h-screen">
          <div className="flex justify-between items-center mb-6">
            <div className="flex gap-6">
              <Link href="/masyarakat/pengajuan-surat/sk-mahar/buat-surat-baru">
