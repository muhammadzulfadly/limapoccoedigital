...
export default async function Page() {
  const data = [
    { tanggal: "24/03/25", jenis: "Keterangan tidak mampu", status: "Selesai", action: "Unduh" },
    { tanggal: "24/03/25", jenis: "Keterangan tidak mampu", status: "Butuh Konfirmasi", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan tidak mampu", status: "Ditolak", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan tidak mampu", status: "Ditolak", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan tidak mampu", status: "Sedang proses", action: "Buka" },
  ];
    ...
    <div className="flex h-full">
      <div className="flex-1 bg-gray-100 p-8">
        <h1 className="text-xl font-semibold mb-6">
          Pengajuan Surat / <span className="font-bold">SK Tidak Mampu</span>
        </h1>
