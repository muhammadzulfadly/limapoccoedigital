...
export default async function Page() {
  const data = [
    { tanggal: "24/03/25", jenis: "Keterangan lahir", status: "Selesai", action: "Unduh" },
    { tanggal: "24/03/25", jenis: "Keterangan lahir", status: "Butuh Konfirmasi", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan lahir", status: "Ditolak", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan lahir", status: "Ditolak", action: "Buka" },
    { tanggal: "24/03/25", jenis: "Keterangan lahir", status: "Sedang proses", action: "Buka" },
  ];
