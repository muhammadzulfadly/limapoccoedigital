...
export default async function Page() {
  ...
  const data = [
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Sedang proses", jenis: "SK kelahiran", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Sedang proses", jenis: "SK kelahiran", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Butuh Konfirmasi", jenis: "SK kelahiran", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Ditolak", jenis: "SK kelahiran", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Selesai", jenis: "SK kelahiran", action: "Unduh" },
  ];
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 bg-gray-100 p-8">
        <header>
          <h1 className="text-xl font-bold mb-6">Dashboard Pengajuan Surat / SK Kelahiran</h1>
        </header>
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex gap-6">
            <Link href="/admin/pengajuan-surat/sk-kelahiran/buat-surat-baru">
