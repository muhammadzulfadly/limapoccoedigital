...
export default async function Page() {
  ...
  const data = [
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Sedang proses", jenis: "SK usaha", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Sedang proses", jenis: "SK usaha", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Butuh Konfirmasi", jenis: "SK usaha", action: "Buka" },
    { tanggal: "24/03/25", nama: "Asep Sofyan", status: "Ditolak", jenis: "SK usaha", action: "Buka" },
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 bg-gray-100 p-8">
        <header>
          <h1 className="text-xl font-bold mb-6">Dashboard Pengajuan Surat / SK Usaha</h1>
        </header>
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex gap-6">
            <Link href="/admin/pengajuan-surat/sk-usaha/buat-surat-baru">
